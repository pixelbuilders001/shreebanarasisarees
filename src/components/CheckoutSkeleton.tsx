  ...
  return (
    <div className="min-h-screen bg-[#FAF7F0] text-[#292524] flex flex-col font-sans pb-32 lg:pb-16">
      ...
      <div className="bg-white border-b border-[#F3ECE0] px-4 py-3">
        <div className="max-w-xl lg:max-w-6xl mx-auto flex items-center justify-center gap-4">
        ...
        <div className="lg:grid lg:grid-cols-12 lg:gap-8 items-start">
          ...
          <div className="lg:col-span-7 xl:col-span-7 space-y-4">
            ...
            <div className="bg-white rounded-2xl border border-[#E5DEC9] p-4 space-y-3 shadow-2xs">
              ...
              <div className="flex lg:grid lg:grid-cols-2 gap-3 overflow-hidden">
                {[0, 1].map((n) => (
                  <div
                    key={n}
                    className="w-[240px] sm:w-[260px] lg:w-auto shrink-0 lg:shrink bg-white rounded-xl border border-[#E5DEC9] p-3 animate-pulse"
                  >
            ...
            {/* MOBILE ONLY ORDER SUMMARY SKELETON */}
            ...
            <div className="bg-white rounded-2xl border border-[#E5DEC9] p-5 space-y-4 shadow-sm">
              ...
              <div className="space-y-3 pt-2">
                {[0, 1].map((n) => (
                  <div key={n} className="flex items-center justify-between gap-3 animate-pulse">
                    <div className="flex items-center gap-3 min-w-0 flex-1">
                      <div className="w-14 h-16 rounded-xl bg-stone-200 shrink-0" />
                      <div className="flex-1 space-y-2">
                        <div className="w-3/4 h-3 bg-stone-200 rounded-md" />
                        <div className="w-1/2 h-2 bg-stone-200 rounded-md" />
                      </div>
                    </div>
                    <div className="w-16 h-4 bg-stone-200 rounded-md shrink-0" />
                  </div>
                ))}
              </div>
              <div className="border-t border-[#F3ECE0] pt-4 space-y-2.5">
                ...
                <div className="border-t border-[#E5DEC9] pt-3 flex justify-between">
                  <div className="w-16 h-5 bg-stone-200 rounded animate-pulse" />
                  <div className="w-24 h-6 bg-stone-200 rounded animate-pulse" />
                </div>
              </div>
              <div className="w-full h-12 bg-stone-200 rounded-full animate-pulse mt-2" />
            </div>
          </div>
        </div>
      </main>
