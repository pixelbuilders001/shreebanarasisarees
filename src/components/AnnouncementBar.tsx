...
export const AnnouncementBar: React.FC = () => {
  ...
  return (
    <div className="hidden lg:block bg-[#52111C] text-[#FAF7F0] text-xs py-1.5 px-3 border-b border-[#B08A3C]/25 select-none z-50 relative font-sans font-medium tracking-wide">
