...
export type DisplayStyle = 'horizontal' | 'grid' | 'carousel' | 'category_cards' | 'banner' | 'banners_showcase' | 'banner_showcase' | 'pinterest_grid' | 'featured' | 'offer_timer' | 'image_banner' | string;
